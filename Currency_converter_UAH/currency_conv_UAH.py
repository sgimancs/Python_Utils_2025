...
eur_buy = Label(header_frame, text=JSON_object[0]['buy'], bg="#ccc", font="Arial 10")
eur_buy.grid(row=2, column=1, sticky=EW)
eur_sale = Label(header_frame, text=JSON_object[0]['sale'], bg="#ccc", font="Arial 10")
...
usd_buy = Label(header_frame, text=JSON_object[1]['buy'], font="Arial 10")
usd_buy.grid(row=1, column=1, sticky=EW)
usd_sale = Label(header_frame, text=JSON_object[1]['sale'], font="Arial 10")
